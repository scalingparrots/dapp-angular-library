...
export declare class WalletConnectModal {
    ...
    private initUi;
    openModal: (options?: import("../../../../modal-core/dist/_types/src/controllers/ModalCtrl").OpenOptions | undefined) => Promise<void>;
    closeModal: () => void;
    subscribeModal: (callback: (newState: import("../../../../modal-core/dist/_types/src/types/controllerTypes").ModalCtrlState) => void) => () => void;
