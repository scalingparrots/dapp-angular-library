...
function getSignature(signature) {
    ...
    return secp256k1_1.secp256k1.Signature.fromCompact(signature);
}
...
function publicKeyCreate(privateKey, compressed = true, out) {
    ...
    const res = secp256k1_1.secp256k1.getPublicKey(privateKey, compressed);
...
function signatureImport(signature, out) {
    ...
    const sig = secp256k1_1.secp256k1.Signature.fromDER(signature);
...
function ecdh(publicKey, privateKey, options = {}, out) {
    ...
    const point = Point.fromHex(secp256k1_1.secp256k1.getSharedSecret(privateKey, publicKey));
